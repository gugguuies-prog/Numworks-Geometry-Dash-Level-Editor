          ...
          >
            <div 
              style={{
                ...
                borderBottom: spike.orientation === 0 ? `${TILE_H * 0.49 * zoom}px solid ${rgbString(level.groundColor)}` : 'none',
                borderTop: spike.orientation === 1 ? `${TILE_H * 0.49 * zoom}px solid ${rgbString(level.groundColor)}` : 'none',
              }}
            />
          </div>
        ))}
